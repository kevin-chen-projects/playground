...
## Archived (still browsable for fun)

Retired experiments, kept live for browsing — see [archive/](archive/):

- [Birthday Slots](https://kevin-chen-projects.github.io/playground/archive/slot-machine.html) — 3-reel slot machine
- [Birthday Slots (Memes)](https://kevin-chen-projects.github.io/playground/archive/slot-machine-memes.html) — slots with meme SFX
- [Glow Studio Easy](https://kevin-chen-projects.github.io/playground/archive/glow-studio-easy.html) — one-tap mobile photo variant

---

## Moved to a private repo

Moved out for monetization development — no longer publicly hosted: Bio Basics, NiHao, Math
Ace, Habla Clara, Hello!, Speak Sharp, Interview Drill, Count Champ, Holdem Coach, FluoroMatch,
Mortgage Lab, Fridge Feast, Glow Studio Video, Slop Shield, Stock Screener.
